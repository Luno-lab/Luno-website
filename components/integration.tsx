        ...
        <div className="max-w-4xl mx-auto space-y-12">
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  {(() => {
                    ...
                    const codeToCopy = 'npm i @luno-kit/react @luno-kit/ui'
                    return (
                      <Button
                        variant="ghost"
                        size="sm"
                      ...
                      >
                        {copied ? (
                          ...
                          <Copy className="h-4 w-4 transition-colors hover:text-white" />
                        )}
                      </Button>
                    )
                  })()}
          ...
          <ScrollReveal delay={0.3} className="space-y-6">
            <div className="flex gap-4 items-center">
              ...
              <h3 className="text-xl font-semibold text-white">Set up your React snippet and customize</h3>
            </div>
            ...
            <Card className="bg-gray-900 border-gray-800 relative">
              <CardContent className="p-0">
                ...
                {/* Copy button */}
                {(() => {
                  const codeToCopy = `import { LunoKitProvider, ConnectButton } from '@luno-kit/ui'
import {
